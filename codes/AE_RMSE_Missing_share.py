...
def test_AE(data='',validationdata= '', param_list= None,n_hidden = 144,share= False,missing = True,
...
if __name__ == '__main__':
    ...
    training_epochs = 10
    batch_size = 3000
    test_AE(dataset,validationset, param_list,100,True,missing = missing2, missing_rate = 0,
